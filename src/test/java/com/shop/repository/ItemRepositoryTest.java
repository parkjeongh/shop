...
class ItemRepositoryTest {
    ...
    public void queryDslTest2(){
        ...
        booleanBuilder.and((Predicate) item.itemDetail.like("%" + itemDetail + "%"));
        booleanBuilder.and((Predicate) item.price.gt(price));

        if (StringUtils.equals(itemSellStat, ItemSellStatus.SELL)){
            booleanBuilder.and((Predicate) item.itemSellStatus.eq(ItemSellStatus.SELL));
        }
